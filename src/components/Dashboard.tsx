  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Typography
        ...
        sx={{ mb: 2 }}
      >
                        Get intelligent investment recommendations for the top 200 cryptocurrencies, powered by advanced technical analysis. Data updates automatically every hour.
      </Typography>
